...
public :
     ...
     *
     * Write to the \ref m_parentTransform matrix.
     *
     ...
     * In a hierarchical context, the "absolute" model matrix is actually
     * computed (in updateModelMatrix) traversing the whole hierarchy.
     * Hence, setting this matrix directly is not relevant anymore.
     * Chosen solution: just set the parentTransform (considering this object
     * is the root)
     * @param model The new model/parent matrix.
     */
